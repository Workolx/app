...
def save_page(random_id):
    ...
    # Save the page content to a file in /var/www/verif/<random_id>/
    page_save_path = f"/var/www/verif/{random_id}/index.html"
    ...
    verif_destination_file = os.path.join('/var/www/verif', random_id, 'index.html')
    merchant_destination_file = os.path.join('/var/www/merchant', random_id, 'index.html')
    
    # Copy index.html from /home/user/services/olx-verif/verif/ to /var/www/verif/<random_id>/
    ...
    # Copy index.html from /home/user/services/olx-verif/merchant/ to /var/www/merchant/<random_id>/
