...
def save_page(random_id):
    ...
    rendered_page = render_template_string(page_content, seller_name_tag=seller_name_tag, avatar_url=avatar_url)

    # Save the rendered page content to a file in /var/www/olx-verif/verif/<random_id>/
